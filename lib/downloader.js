...
module.exports = curry$(function(getRequestArgs, fetchPutioEntry, putioEntries, opts){
  ...
  downloadPutioFile = curry$(function(bw, filesTotal, putioFile){
    var filePath;
    filePath = path.join(opts.path, putioFile.path);
    return mkdirp.mkdirpAsync(path.dirname(filePath))['catch'](function(){}).then(function(){
      var logEvent;
      logEvent = {
        fileNum: fileNum,
      ...
      return new Promise(function(resolved, rejected){
        ...
        }).on('error', onError).pipe(fs.createWriteStream(filePath));
      })['finally'](function(){
        return fileNum += 1;
      });
    });
